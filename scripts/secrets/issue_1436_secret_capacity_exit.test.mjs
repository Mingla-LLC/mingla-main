...
test("issue #1436: final manifest is exactly 85 unique names with no exception or retired direct record", () => {
  ...
  assert.equal(manifest.rollout.expected_user_managed_count, 85);
  assert.equal(manifest.policy.normal_ceiling, 85);
