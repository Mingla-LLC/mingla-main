          ...
          <CardContent className="p-6 space-y-4">
            ...
            <div className="flex gap-3 pt-4">
              ...
              <motion.button
                ...
                className="flex-1 h-14 rounded-2xl border-2 border-red-200 bg-red-50 text-red-600 hover:bg-red-100 hover:border-red-300 transition-all flex items-center justify-center font-semibold"
              >
                <X className="h-6 w-6" />
              </motion.button>
              ...
              <motion.button
                ...
                className="h-14 px-4 rounded-2xl border-2 border-blue-200 bg-blue-50 text-blue-600 hover:bg-blue-100 hover:border-blue-300 transition-all flex items-center justify-center font-semibold"
              >
              ...
              <motion.button
                whileTap={{ scale: 0.95 }}
                onClick={() => onLike(card)}
                className="flex-1 h-14 rounded-2xl border-2 border-green-200 bg-green-50 text-green-600 hover:bg-green-100 hover:border-green-300 transition-all flex items-center justify-center font-semibold"
              >
