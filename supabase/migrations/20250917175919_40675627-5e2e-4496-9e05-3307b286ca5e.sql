...
DELETE FROM public.board_collaborators WHERE board_id IN (
  SELECT id FROM public.boards WHERE name IN ('NYC Weekend Adventures', 'Brooklyn Food Tour', 'Art & Culture Crawl', 'Central Park & Chill')
);

DELETE FROM public.boards WHERE name IN ('NYC Weekend Adventures', 'Brooklyn Food Tour', 'Art & Culture Crawl', 'Central Park & Chill');

DELETE FROM public.saves WHERE profile_id IN (
  SELECT id FROM public.profiles WHERE username IN ('sarah_explorer', 'mike_adventures', 'emma_foodie', 'alex_culture', 'lisa_nature')
);

DELETE FROM public.profiles WHERE username IN ('sarah_explorer', 'mike_adventures', 'emma_foodie', 'alex_culture', 'lisa_nature');
