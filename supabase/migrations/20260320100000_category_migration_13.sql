-- Migration: category_migration_13
-- Migrates from 12 categories to 13: split Groceries & Flowers, add Live Performance,
-- rename Nature → Nature & Views display name, standardize Picnic → Picnic Park,
-- remove Work & Business. Backfills card_pool, place_pool, and user profiles.
-- Also updates query_pool_cards to exclude Groceries-only cards from regular serving.

-- ═══════════════════════════════════════════════════════════════════════════════
-- Part 1: card_pool category renaming
-- ═══════════════════════════════════════════════════════════════════════════════
...
-- Groceries & Flowers → split based on place_pool primary_type
-- Florist places → Flowers
UPDATE public.card_pool
...
-- Work & Business — deactivate cards that are ONLY tagged Work & Business
UPDATE public.card_pool
SET is_active = false
...
-- ═══════════════════════════════════════════════════════════════════════════════
-- Part 4: Rewrite query_pool_cards with Groceries exclusion
-- ═══════════════════════════════════════════════════════════════════════════════
