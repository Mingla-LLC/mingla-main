...
-- Create demo experiences/cards with valid category slugs
...
('e2222222-2222-2222-2222-222222222222', 'Coffee at Blue Bottle', 'Sip & Chill', 'coffee', 40.7614, -73.9776, 5, 15, 45, 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400', '{"description": "Artisanal coffee in a cozy atmosphere"}'),
('e3333333-3333-3333-3333-333333333333', 'Museum of Modern Art', 'Culture', 'culture', 40.7614, -73.9776, 25, 25, 120, 'https://images.unsplash.com/photo-1554907984-15263bfd63bd?w=400', '{"description": "World-class modern art collection"}'),
...
('e5555555-5555-5555-5555-555555555555', 'Broadway Show', 'Entertainment', 'entertainment', 40.7589, -73.9851, 80, 200, 180, 'https://images.unsplash.com/photo-1507924538820-ede94a04019d?w=400', '{"description": "World-class Broadway musical performance"}')
ON CONFLICT (id) DO NOTHING;
