-- Fix query_person_hero_cards: add slug normalization + dedup parameter
-- Slug normalization: converts display names to DB slugs (same pattern as query_pool_cards)
-- Dedup parameter: allows client to exclude cards already shown in other sections
