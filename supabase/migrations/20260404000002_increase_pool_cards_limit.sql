-- Increase query_pool_cards default limit from 20 to 200.
-- Users should see ALL matching cards, not an artificial 20-card batch.
-- The 20-card limit was a leftover from offset-based pagination (removed in 20260401000001).

-- Drop current signature (14 params including p_exclude_place_ids)
