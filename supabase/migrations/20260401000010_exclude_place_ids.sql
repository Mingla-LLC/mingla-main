-- Add p_exclude_place_ids TEXT[] parameter to query_pool_cards.
-- Compares against cp.google_place_id (Google Place IDs like "ChIJwSz...")
-- instead of cp.id (UUID). This is the correct exclusion for saved/scheduled cards
-- since the API response uses google_place_id as the card ID.

-- Drop old signature (13 params)
