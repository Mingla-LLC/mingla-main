-- Budget "Any" option: when p_price_tiers contains 'any', bypass all price/tier filtering.
-- This allows users to see cards from ALL price tiers including NULL-priced places.

-- Drop the existing signature so CREATE OR REPLACE can change it cleanly
