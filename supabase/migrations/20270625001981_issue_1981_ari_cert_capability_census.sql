-- Issue #1981 — re-pin Ari certification capability census after refund/cancel
-- discovery reads. Adds get_order_refund_preview + list_trip_installments
-- (+2 registered tools) and two ledger capability rows (135 → 137).
-- Restores Pass-5 finalize_run count gate to the live ledger size.
-- MONOTONIC VERSION 20270625001981 (after 20270624003193 on disk).
