...
create table public.app_version_policies (
  ...
  minimum_version text not null check (
    minimum_version ~ '^(0|[1-9][0-9]*)\.(0|[1-9][0-9]*)\.(0|[1-9][0-9]*)$'
  ),
...
insert into public.app_version_policies (
  ...
  ('explorer', 'ios', '1.1.4', 'https://apps.apple.com/app/id6760440898', 'observe'),
  ('explorer', 'android', '1.1.4', 'https://play.google.com/store/apps/details?id=com.mingla.app.v2', 'observe'),
  ('business', 'ios', '1.1.4', 'https://apps.apple.com/app/id6768737367', 'observe'),
  ('business', 'android', '1.1.4', 'https://play.google.com/store/apps/details?id=com.sethogieva.minglabusiness', 'observe');
