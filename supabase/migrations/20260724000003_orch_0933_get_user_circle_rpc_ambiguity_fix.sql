-- ORCH-0933 rework — repair live get_user_circle RETURNS TABLE ambiguity.
-- 20260724000002 is already present on the linked dev DB; this monotonic
-- replacement is what the operator-controlled migration path can apply.
