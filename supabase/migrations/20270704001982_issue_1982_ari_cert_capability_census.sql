-- Issue #1982 — re-pin Ari certification capability census after Brand People /
...
VALUES
  ('ari.team.revoke_invitation', 'write')
...
BEGIN
  ...
  END IF;
  IF v_capability_count <> 138 THEN RAISE EXCEPTION 'ari_cert_missing_capabilities:%', v_capability_count; END IF;
