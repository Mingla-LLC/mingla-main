-- ═══════════════════════════════════════════════════════════════════════════════
-- 1. admin_pool_intelligence_overview — FIXED: use card_pool.city_id
-- ═══════════════════════════════════════════════════════════════════════════════
...
BEGIN
  ...
  SELECT
    ...
    -- FIXED: use card_pool.city_id (now exists)
...
-- ═══════════════════════════════════════════════════════════════════════════════
-- 2. admin_pool_category_health — FIXED: join now works (both sides use slugs)
-- ═══════════════════════════════════════════════════════════════════════════════
...
BEGIN
  ...
  SELECT
    ...
    END AS photo_pct,
    ps.avg_rating,
    -- FIXED: join works because both sides now use slugs
