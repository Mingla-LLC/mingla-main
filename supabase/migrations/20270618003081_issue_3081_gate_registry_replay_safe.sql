...
-- every table in this schema must carry RLS (#1860). No policy: the only legitimate
-- readers are the migration applier and the fixtures, both of which run as the owner.
