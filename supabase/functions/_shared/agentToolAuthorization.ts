...
> = Object.freeze({
  ...
  update_campaign_draft: role("marketing_manager", "campaign"),
  delete_campaign_draft: role("marketing_manager", "campaign"),
  ...
  get_growth_tool_report: role("marketing_manager", "brand"),
