...
const manageTripDays = tripGraphTool(
  "manage_trip_days",
  "Replace the ordered itinerary days on a trip.",
  {
...
const manageTripInclusions = tripGraphTool(
  ...
  "Replace a trip's included and excluded items.",
  {
...
const manageTripTiers = tripGraphTool(
  "manage_trip_tiers",
  "Create, update, or explicitly remove trip packages.",
  {
    ticket_type_id: UUID,
    tier_name: STR,
...
const manageTripTravelerIntake = tripGraphTool(
  ...
  "Replace per-tier traveler intake schemas.",
