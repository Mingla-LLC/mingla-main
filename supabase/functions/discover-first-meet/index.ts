...
serve(async (req: Request) => {
  ...
  try {
    ...
    const firstMeetExcluded = getExcludedTypesForCategory('First Meet');
    allPlaces = filterExcludedPlaces(allPlaces, firstMeetExcluded) as typeof allPlaces;
    console.log(`[discover-first-meet] ${allPlaces.length} places after exclusion filter`);
