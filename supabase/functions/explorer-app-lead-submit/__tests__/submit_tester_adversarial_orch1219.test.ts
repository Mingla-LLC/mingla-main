...
// tester adversarial (ORCH-1219) assertions (incl. the beta TestFlight-link email) were removed under
// [TEST-MOD-APPROVED ORCH-1319]. No TestFlight URL, no handler import.

Deno.test("explorer-app-lead-submit tester adversarial (ORCH-1219) decommissioned by ORCH-1319 (beta lead-form retired at store launch)", () => {
