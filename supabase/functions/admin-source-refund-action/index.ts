...
export async function resolveAdminActionContext(
  authorization: string,
  ...
  return {
    ...
    // p_actor_email audits WHO acted; the authenticated identity is the
    // truthful answer and no longer depends on an orphaned admin_users row.
