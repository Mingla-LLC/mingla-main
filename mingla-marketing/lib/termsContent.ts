...
export const TERMS_SECTIONS = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Subject to Section 18 (Dispute Resolution; Binding Arbitration; Class Action Waiver), any dispute or claim not subject to arbitration will be brought exclusively in the state or federal courts located in New Castle County, Delaware, and you and Mingla each consent to the personal jurisdiction and venue of those courts and waive any objection based on inconvenient forum.',
    ],
  },
  {
