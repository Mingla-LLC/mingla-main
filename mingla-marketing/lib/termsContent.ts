export const TERMS_EFFECTIVE_DATE = 'May 27, 2026'
...
export const TERMS_SECTIONS = [
  ...
  {
    title: '5. Phone Verification, SMS, and Push Notifications',
    paragraphs: [
  ...
  },
  {
    ...
    paragraphs: ['You agree not to, and not to permit any third party to:'],
    bullets: [
  ...
  {
    title: '11. In-Person Meetings, Real-World Interactions, and Safety',
    paragraphs: [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Subject to Section 18 (Dispute Resolution; Binding Arbitration; Class Action Waiver), any dispute or claim not subject to arbitration will be brought exclusively in the state or federal courts located in Mecklenburg County, North Carolina, and you and Mingla each consent to the personal jurisdiction and venue of those courts and waive any objection based on inconvenient forum.',
    ],
  },
  {
