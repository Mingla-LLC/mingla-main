// ---------------------------------------------------------------
// DC Showcase Places — ORCH-1007 [marketing real place cards — DC test run]
//
...
/**
 * Headline-pill label + icon (ORCH-1007 hero-pill sync). Each card carries the
...
export interface ShowcasePlace {
   ...
   * when the place has no real price → the card renders "Free" (ORCH-1007 v2.4).
   */
   ...
   * run. Do NOT wire to a backend. (ORCH-1007 v2.6)
   */
  recommendCount: number
}

// Fixed character budget for every card description (ORCH-1007 v3.5). All
