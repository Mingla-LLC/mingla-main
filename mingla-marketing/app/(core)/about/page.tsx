...
export default function AboutPage() {
  ...
  return <CorePageShell>
    ...
    <CutoutSection id="two-jobs"><div className="core-section-heading"><h2>One platform, two jobs.</h2><p>People need a decision they can act on. Hosts need a clear way to make the experience understandable and available.</p></div><div className="core-two">
      ...
      <article className="core-card"><h3>For people making the experience possible</h3><p>Mingla Host is for organisers, restaurants, bars, cafés, venues, activity spaces, experience brands, trip operators and independent creators. Hosts can present, publish, promote and run only the workflows Mingla currently supports.</p><figure className="core-host-proof"><Image src="/product-proof/host-live-public-page.png" alt="Mingla Host showing the Sample rooftop listening session open in its public event page with a free-ticket action." width={1206} height={2622} sizes="(min-width: 768px) 40vw, 92vw" /></figure><DeviceCta surface="host" location="about_host" label="Host Your City" /></article>
    </div></CutoutSection>
