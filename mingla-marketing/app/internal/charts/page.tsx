...
export const metadata = publicNoindexMetadata('/internal/charts', {
  title: 'Chart bank — Mingla internal',
  description: 'Every figure Mingla has, live and new, with what each shows and where it lives.',
})
