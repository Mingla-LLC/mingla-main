...
const glassNav = read('components/marketing/glass-nav.tsx')
...
assert.match(glassNav, /mingla-business-logo\.png[\s\S]*?h-20 w-20 scale-\[1\.44\]/)
assert.match(glassNav, /mingla-wordmark\.svg[\s\S]*?h-7 w-auto/)
