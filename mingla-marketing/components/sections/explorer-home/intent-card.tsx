...
// ---------------------------------------------------------------
// Intent Card — ORCH-1001 [marketing real place cards — DC test run]
//
...
// DESIGN_ORCH-1001_MARKETING_PLACE_CARD_DC.md "Intent Card v1" (§I.1–I.9).
//
...
const CARD_W = 260
// 🔒LOCKED (ORCH-1001 v2.1 / §I.6): same 360 as the single card — the intent
