...
// vibe". ORCH-1001 hero-pill sync: it is now DRIVEN by the rotating deck. The
...
interface ExplorerHeroProps {
  /** Server-resolved marketing city (ORCH-1001 location-aware). Defaults to DC. */
  cityKey?: CityKey
}
...
export function ExplorerHero({ cityKey = DEFAULT_CITY }: ExplorerHeroProps) {
  ...
  // the deck's front card and the headline pill (ORCH-1001 hero-pill sync).
