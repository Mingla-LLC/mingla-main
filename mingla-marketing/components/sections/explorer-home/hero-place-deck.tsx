...
// ---------------------------------------------------------------
// Hero Place Deck — ORCH-1007 [marketing real place cards — DC test run]
//
...
// 🔒 Shared rotation cadence (ORCH-1007 hero-pill sync). ONE 2000ms tick drives
...
const CARD_W = 260
// 🔒LOCKED (ORCH-1007 v2.1): 360 is the tallest height that clears a 768px-tall
...
// (ORCH-1007 location-aware). The cadence is identical to the original DC-only
...
// ---------------------------------------------------------------
// Headline-pill resolution (ORCH-1007 hero-pill sync). The pill word + icon
...
// ORCH-1007 location-aware: the rotation now depends on the RESOLVED city. The
      ...
      >
        ...
        >
          ...
          {/* Price slot — shown ONLY when a real price exists. Honest: a
              ...
              name only and NEVER a fake "Free" (ORCH-1007 real-assembly rule). */}
          {place.priceRange ? (
            <span
              className="font-sans"
              style={{
