...
ok(
  "R1f the trip body owns a single gorhom-aware scroll host (BottomSheetScrollView), not a raw RN ScrollView",
  /BottomSheetScrollView/.test(detailSrc) &&
    !/<ScrollView\b/.test(detailSrc),
  "scrollMode='view' + BottomSheetScrollView mirrors ExpandedBusinessEventSheet's single-scroll structure",
);
...
console.log(
  `\n# ORCH-1016 consumer-trip-detail REWORK (canonical sheet + nav clearance) — ${passed} checks PASS`,
);
