...
export const COACH_STEPS: CoachStep[] = [
  ...
  },
  {
    ...
    description: "Pair with your partner or closest people. Get a dedicated view of their world \u2014 birthdays, holidays, shared saves, and cards picked just for you two.",
    buttonLabel: 'Got it',
  },
  {
    id: 10,
    ...
    description: "Add friends, manage your circle, and message anyone directly. Share saves, plan outings, and keep the conversation going \u2014 all in one place.",
    buttonLabel: 'Got it',
  },
  {
    id: 11,
