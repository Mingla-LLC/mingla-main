...
export type PreparedContentShare = {
...
export const messageForPreparedContentShare=(prepared:PreparedContentShare,channel='generic',messageContext:ShareMessageContext={}):PreparedContentShare=>({...prepared,message:buildShareMessage(prepared.facts,{shortCode:prepared.shortCode,channel:channel as never,...messageContext})});
