 ...
 */
// Exported for ORCH-0850 regression test at __tests__/calendarTab.archivePartition.test.tsx.
...
export function computeEntryEffectiveEnd(entry: CalendarEntryForBucketing): Date | null {
  const startIso =
