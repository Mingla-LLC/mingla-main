...
function SidebarInset({ style, ...props }: { style?: any; children: React.ReactNode }) {
  return (
    <View
      style={[styles.sidebarInset, style]}
      {...props}
    />
  );
}
...
function SidebarInput({
  ...
  return (
    <Input
      style={[styles.sidebarInput, style]}
      {...props}
    />
  );
}

function SidebarHeader({ style, ...props }: { style?: any; children: React.ReactNode }) {
  return (
    <View
      style={[styles.sidebarHeader, style]}
      {...props}
    />
  );
}

function SidebarFooter({ style, ...props }: { style?: any; children: React.ReactNode }) {
  return (
    <View
      style={[styles.sidebarFooter, style]}
      {...props}
    />
  );
}
...
function SidebarSeparator({
  ...
  return (
    <Separator
      style={[styles.sidebarSeparator, style]}
      {...props}
    />
  );
}

function SidebarContent({ style, ...props }: { style?: any; children: React.ReactNode }) {
  return (
    <ScrollView
...
function SidebarGroupAction({
  ...
  asChild = false,
  ...props
}: React.ComponentProps<typeof TouchableOpacity> & { asChild?: boolean }) {
