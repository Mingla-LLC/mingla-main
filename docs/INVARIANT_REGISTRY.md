...
## DRAFT — issue #1014 (free-only publishes never require payment setup; money-bearing transitions fail close with actionable copy — IN FLIGHT, registered at SPEC 2026-07-20)

> Registered DRAFT at issue #1014 SPEC. Root cause (issue #1014 investigation, 5-layer proven): ORCH-0769's `tg_require_event_brand_currency` raised `event_currency_required` on EVERY draft→published transition when the brand currency was unresolvable — contradicting ORCH-1075/1076's explicit free/door-only exemption from payment-setup gating — so a fresh brand could publish NOTHING (7× prod errors 2026-07-20, brand `3c0f39f5-…` "Lagos Party Be"), and NG Paystack brands could NEVER publish (`brand-paystack-onboard` never wrote `brands.default_currency`). The fix direction (Seth's steering comment on #1014) splits the guard by MONEY, not by publish. The orchestrator flips DRAFT → ACTIVE at CLOSE. Cross-ref: SPEC comment on issue #1014.

### I-PROPOSED-1014-FREE-PUBLISH-NO-PAYMENT-SETUP (DRAFT — issue #1014 SPEC 2026-07-20)
...
- **Established:** DRAFT 2026-07-20 at issue #1014 SPEC. Flips ACTIVE at CLOSE.

### I-PROPOSED-1014-MONEY-FAILS-CLOSE-ACTIONABLY (DRAFT — issue #1014 SPEC 2026-07-20)
