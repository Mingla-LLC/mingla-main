...
## DRAFT — issue #1322 (crash reporting Sentry lit up on the admin console mingla-admin — flip ACTIVE at CLOSE)
...
### I-PROPOSED-1322-A ADMIN_SENTRY_INIT_DSN_GATED (DRAFT)
...
- **Established:** DRAFT 2026-07-28 at issue #1322 IMPLEMENT (branch `1322-admin-sentry`); flip ACTIVE at CLOSE after tester PASS.

### I-PROPOSED-1322-B PROD_ADMIN_SENTRY_DSN_PRESENT (DRAFT)
