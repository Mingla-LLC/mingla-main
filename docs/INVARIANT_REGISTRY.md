...
## DRAFT — issue #957 (NUL-byte test fixture is grep-invisible: stale ORCH-1382 strings survived the 1383→1399 sweep — registered at IMPLEMENT 2026-07-27)
...
### I-PROPOSED-957-LINKS-SRC-ORCH-ID-CONSISTENCY (DRAFT)
