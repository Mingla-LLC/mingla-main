// ORCH-1201 — Admin API-Health hub. A board of per-service cards grouped by
    ...
    <div className="flex flex-col gap-6">
      ...
      {loading ? (
        ...
        <AlertCard variant="info" title="No services registered">
          The monitored-service registry is empty. Apply the ORCH-1201 migration to seed it.
        </AlertCard>
      ) : (
