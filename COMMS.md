...
|---|---|---|---|---|---|---|---|---|
| COMMS-0118 | 2026-07-19 | orchestrator | ALL | WARN | OPEN | none | mingla-implementor+claude (#976), mingla-product+claude, mingla-tester+claude (#976 test), mingla-tester+claude (#882 test), mingla-forensics+claude (#1014 spec), mingla-implementor+claude (#1014), mingla-tester+claude (#1014 test), mingla-forensics+claude (#1022 spec), mingla-implementor+claude (#1022), codex (Drive access check 2026-07-20) | Operating model migrated (issue #974): work is tracked as GitHub issues on the Mingla Avengers board; `Mingla_Artifacts/`, `Mingla_Roadmap/`, and the old `COMMS_LEDGER.md` are retired (history at tag `pre-avengers-archive`). Write comms here, work docs to the issue. In-flight sessions started before 2026-07-19: finish on your current branch, but file your close as an issue comment, not an artifact .md. |
