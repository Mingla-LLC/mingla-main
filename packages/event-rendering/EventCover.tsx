 ...
 *
 * Stripe pattern: parallel <Rect> elements rotated 45° inside react-native-svg,
 * approximating `repeating-linear-gradient(135deg, base 0 14px, alt 14px 28px)`.
 * Bottom vignette via expo-linear-gradient.
 */
