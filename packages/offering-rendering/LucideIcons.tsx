...
export const Copy = (props: LucideIconProps) => (
  <LucideFrame {...props}>
...
export const Check = (props: LucideIconProps) => (
  <LucideFrame {...props}>
    <Path d="M20 6 9 17l-5-5" />
  </LucideFrame>
);

/** lucide `clock` — the circle + the two hands (experience start-time chip). */
export const Clock: React.FC<LucideIconProps> = (props) => (
  <LucideFrame {...props}>
    <Circle cx={12} cy={12} r={10} />
    <Path d="M12 6v6l4 2" />
  </LucideFrame>
...
/** lucide `sparkles` — the four-point star + two tiny accents (vibe chips). */
export const Sparkles: React.FC<LucideIconProps> = (props) => (
  <LucideFrame {...props}>
