...
| Curated card hero image missing | F | — | INVESTIGATION_CARD_HEALTH_PHOTO_COVERAGE.md | 844 curated cards have photos in stops JSONB but card-level image_url/images never set. generate-curated-experiences skips this step. Planned for Block 5b. |
| Single card orphans (no photos) | F | — | INVESTIGATION_CARD_HEALTH_PHOTO_COVERAGE.md | 6 linkable by google_place_id, 29 true orphans to deactivate. Planned for Block 5b. |
| Card Health photo metric mislabeled | F | — | INVESTIGATION_CARD_HEALTH_PHOTO_COVERAGE.md | Shows place-level 100% but card-level is 35-45%. Planned for Block 5b. |
