> Parity note: ported from `.codex/skills/orchestrator-mingla/references/operating-system.md` during META-ORCH-0755-B so Claude orchestrator can load Codex’s consolidated lifecycle, mode, role-boundary, and verification standard.
