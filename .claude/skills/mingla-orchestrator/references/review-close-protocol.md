> Parity note: ported from `.codex/skills/orchestrator-mingla/references/review-close-protocol.md` during META-ORCH-0755-B so Claude orchestrator can load Codex’s review, close, commit, and deploy-note protocol.
