> Parity note: ported from `.codex/skills/orchestrator-mingla/references/mingla-journey-and-invariants.md` during META-ORCH-0755-B so Claude orchestrator can load Codex’s consolidated journey, constitution, invariant, and recurring-pattern reference.
