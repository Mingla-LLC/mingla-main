> Parity note: ported from `.codex/skills/implementor-mingla/references/invariants-and-constitution.md` during META-ORCH-0755-B so Claude implementor can load Codex’s consolidated constitution and invariant reference.
