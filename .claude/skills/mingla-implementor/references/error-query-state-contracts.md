> Parity note: ported from `.codex/skills/implementor-mingla/references/error-query-state-contracts.md` during META-ORCH-0755-B so Claude implementor can load Codex’s consolidated error, query, and state ownership contract.
