> Parity note: ported from `.codex/skills/forensic-mingla/references/report-template.md` during META-ORCH-0755-B. Use this as the broader Codex-style forensic report scaffold; use `investigation-report-template.md` for the strict Claude investigation-only template.
