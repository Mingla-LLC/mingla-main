// ORCH-1207 — bundle the SheetWeb opacity + drag-to-dismiss harness with Metro
// for web. Mirrors playwright/orch1197/bundle.mjs exactly (same anchor-metro +
...
// alias `__ORCH1207_SHEET__` -> absolute worktree path, so the measured panel
...
const tmpDir = fs.mkdtempSync(path.join(anchorBusiness, ".orch1207-harness-"));
...
process.env.EXPO_PUBLIC_SUPABASE_URL ||= "https://orch1207.supabase.co";
process.env.EXPO_PUBLIC_SUPABASE_ANON_KEY ||= "orch1207-anon-key";
...
config.resolver.resolveRequest = (context, moduleName, platform) => {
  if (moduleName === "__ORCH1207_SHEET__") {
...
console.log("ORCH-1207 bundle written:", out);
