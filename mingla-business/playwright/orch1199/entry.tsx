// @ts-nocheck — bundler-only harness entry (metro-resolved `__ORCH1199_SHEET__`
// virtual import + react-dom/client); not part of the app type surface.
/**
 * ORCH-1199 — real-Chromium reproduction harness ENTRY (client render),
 * Android/Samsung profile.
 *
 ...
 * web. The Playwright spec loads the bundle in real Chromium at an Android-Chrome /
 * Samsung viewport (mobile UA + touch + deviceScaleFactor) and measures the panel
 * bottom Y + CTA bottom Y vs the visible (visual) viewport. Not shipped.
 */
import React, { useState } from "react";
import { createRoot } from "react-dom/client";
import { Pressable, Text, TextInput, View } from "react-native";

import { Sheet } from "__ORCH1199_SHEET__";
...
function Harness(): React.ReactElement {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <Sheet visible={open} onClose={() => setOpen(false)} snapPoint="full" testID="orch1199-sheet">
