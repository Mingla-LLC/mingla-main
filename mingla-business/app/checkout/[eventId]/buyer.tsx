...
// ORCH-0847 Phase B — dark-mode theme for the public buyer form. The
// mingla-business checkout canvas (`#0c0e12`) is dark; the package's
// default LIGHT-mode tokens would render unreadable here. These values
// mirror the mingla-business design system (`glass`, `text`, `semantic`,
// `accent` from `src/constants/designSystem.ts`) so the PhoneInput field
// + country picker modal feel native to the rest of the buyer form.
 ...
 *   3. Brand country (when the event payload exposes it; currently undefined
 *      on the PublicBrandProps shape — kept here for forward compatibility).
