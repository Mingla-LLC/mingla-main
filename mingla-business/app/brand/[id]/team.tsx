      ...
      >
        ...
        <View style={styles.emptyHost}>
          <EmptyState
            ...
            // "Switch back and try again" also sat directly above a
            // "Switch account" button — two different switch verbs, adjacent.
            description={
              signedInEmail === null
                ? "This brand isn't in your list. Switch back and try again."
                : undefined
            }
          />
          {/*
