...
// META-ORCH-1255 — the lightweight per-brand settings LIST hook
// (useBrandReservationSettingsList) moved VERBATIM to
// ./useBrandReservationSettingsList.ts (META-ORCH-1255(R2), ORCH-1083 web
// bundle budget: its only consumer is the Hub card list's route chunk).
