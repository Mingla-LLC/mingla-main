/**
 * ConnectPartnerOnboardingBody — lazily-loaded body of /connect-partner-onboarding.
 *
 * ORCH-1083: extracted verbatim from app/connect-partner-onboarding.web.tsx so
 * the Stripe Connect web SDK is the ONLY thing statically imported here, letting
 * the route shell React.lazy it out of the initial web bundle. Stripe calls/params
 * are UNCHANGED. See SPEC §C-1.
 *
 * PARTNER (account-level) Stripe onboarding (ORCH-1052). Mirrors the brand-level
 * page but for partner identity: query param `account_id` instead of `brand_id`.
...
export default function ConnectPartnerOnboardingBody(): React.ReactElement {
