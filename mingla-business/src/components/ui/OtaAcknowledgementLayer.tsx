// #2107 — the blocking acknowledgement layer (Host).
//
    ...
    >
      ...
      <View style={styles.messageGroup}>
        ...
        <Text style={styles.context}>
          {installing
            ? "Host will restart by itself when this finishes."
            : "You can keep using Host while it downloads. It finishes the next time you open the app."}
        </Text>
      </View>
