...
export const WhoCoversCostsSection: React.FC<WhoCoversCostsSectionProps> = ({
  ...
  return (
    <View style={styles.card} testID={testID}>
      ...
      {locked || disabled ? (
        <View
          style={styles.lockFooter}
          accessibilityLiveRegion={disabled ? "polite" : undefined}
        >
          ...
          <Text style={styles.lockReason}>
            {disabled
              ...
              : "Pricing locks once your first ticket sells, so every buyer pays on the same terms."}
          </Text>
        </View>
