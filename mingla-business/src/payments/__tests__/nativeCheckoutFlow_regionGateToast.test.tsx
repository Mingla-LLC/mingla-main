 ...
 * decommissioned (business app).
 *
 * Original purpose (ORCH-0953 §3.8): assert that the business-app native
...
const FLOW_PATH = path.join(__dirname, "..", "nativeCheckoutFlow.native.ts");

describe("ORCH-0955: business native checkout flow region-gate handling deleted", () => {
  it("nativeCheckoutFlow.native.ts MUST NOT reference the deleted region-gate error code", () => {
