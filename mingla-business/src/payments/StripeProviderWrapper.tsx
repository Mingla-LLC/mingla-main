// ORCH-0849 (2026-05-15): web-safe stub. Passthrough Fragment so the root
// layout tree composes identically on web — mingla-business web buyers go
// through Stripe Hosted Checkout (no PaymentSheet, no StripeProvider
