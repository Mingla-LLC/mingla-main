...
> Last updated: 2026-04-19 evening (**ORCH-0526 M2 SHIPPED + CHECKPOINT 2 PASS** — Path B rework deployed (edge fn v34), smoke-tested on Fort Lauderdale: rules_version_id populated + 284/284 result rows tagged with rule_set_version_id + 5 rules fired + manifest v1-initial-seed verified. M3 admin UI is next.) + 2026-04-19 (**ORCH-0532 NEW S1 invariant-violation** — user-reported collab quorum bug: single right-swipe lands on Cards tab without ≥2 participant agreement. Server trigger `check_mutual_like` enforces correctly → root cause almost certainly client-side. Forensics prompt ready at `prompts/FORENSICS_ORCH-0532_COLLAB_SWIPE_TO_BOARD_BUG.md` — awaiting user dispatch to mingla-forensics.) + 2026-04-19 (**ORCH-0520 + ORCH-0521 CLOSED** — session more-menu polish + mute persistence + inline invite. v2 rework shipped. Tester CONDITIONAL PASS on code + all 6 device priority tests PASS on user's OTA build. Grade A. Commit `d31cd499`. OTA published iOS + Android. ORCH-0527 registered for lookup-error live-row polish, S3 design-debt.) + 2026-04-19 (**ORCH-0490 Phase 2.5 verification CLOSED** — NARROW SCOPE verdict, 3 real pending items; **ORCH-0525 registered S1** flag-flip prod gap — AH-138 per-context registry fix not active in production; **DEC-031 logged** mingla_last_mode as accepted architecture; DEC-026 RETRACTED; ORCH-0499 ready to close) + 2026-04-18 (**ORCH-0490 Phase 2.4 CLOSED** — structurally satisfied, no code; AH-147 verification PASS HIGH; DEC-029 logged; ORCH-0518 registered as side discovery) + 2026-04-18 (ORCH-0503 CLOSED v3 PASS device retest 6/6; commit 841d9fb7 pushed; OTA pending) + 2026-04-19 late (Phase 2.3 rework — ORCH-0491 + ORCH-0498 closed)
> Total: 385 | Open: 174 | Closed: 134 (incl ORCH-0520 + ORCH-0521, ORCH-0512 retracted) | Verified (B grade): 24 | Partial: 2 | Deferred: 4 (now incl ORCH-0533) | Partially-shipped: 1 | Program charter: 3 | Phase-0-verified: 3 | Phase-2.1-shipped: 1 | Phase-2.2-shipped: 1 | Phase-2.3-shipped: 1 | Phase-2.4-closed-no-code: 1 | Phase-2.5-verified-narrow: 1 | ORCH-0520-CLOSED-A: 1
