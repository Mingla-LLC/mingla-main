...
- Forensics dispatch (v2 patch): `prompts/FORENSICS_ORCH-0737_SPEC_V2_PATCH.md` (PRIVATE_PROMPT_NOT_VERSIONED: `../prompts/FORENSICS_ORCH-0737_SPEC_V2_PATCH.md`)
- Forensics dispatch (v1 IA): `prompts/INVESTIGATOR_ORCH-0737_FULL_CITY_ASYNC_TRIAL.md` (PRIVATE_PROMPT_NOT_VERSIONED: `../prompts/INVESTIGATOR_ORCH-0737_FULL_CITY_ASYNC_TRIAL.md`)
