...
- Boundary: `prompts/FORENSICS_ORCH-0782_ORGANIZER_RESEND_TICKET_CTA_AND_NOTIFICATION_ROLLUP.md` (PRIVATE_PROMPT_NOT_VERSIONED — prompts are gitignored by design; ORCH-0782 organiser "Resend ticket" CTA + rollup recompute remain that ORCH's scope and out of this SPEC's reach).
