...
> Voice anchored to the Mingla Canonical Voice (confident, modern, concrete — never corporate).
> No invented perks, equity, or benefits — logistics are exactly as stated.

---

## Structured data (for `job_postings` seed)
...
job_postings:
  - slug: multimedia-designer
    ...
    currency: NGN
    salary_period: month
    salary_display: "₦150,000–₦250,000/month"
    applications: rolling
    apply_url: https://career.usemingla.com
    summary: "A graphics + video + motion designer in one — produces social-ready creative for a fast-moving consumer brand, fast, with AI-accelerated output."

  - slug: community-brand-manager
    title: Community & Brand Manager
    ...
    applications: rolling
    apply_url: https://career.usemingla.com
    summary: "Owns Mingla's social presence, brand voice, and community — runs the channels, writes the briefs, manages influencers, and moves fast to support growth and product."
```

---

## Role 1 — Multimedia Designer

**Multimedia Designer — graphics, video, and motion, all in one.**
You'll be the creative engine behind everything Mingla puts in front of the world.
...
Apply at **career.usemingla.com** and complete the form. All fields are required: your name, email, WhatsApp number, preferred salary, your CV, and a link to your portfolio. Show us your best graphics, video, and motion work — we want to see all three.

---

## Role 2 — Community & Brand Manager

**Community & Brand Manager — own our voice, run our channels, grow our people.**
You'll be the face and tempo of Mingla's brand and the connective tissue between community, growth, and product.
...
Apply at **career.usemingla.com** and complete the form. All fields are required: your name, email, WhatsApp number, preferred salary, your CV, and a portfolio link (samples of your social work, campaigns, or writing). Show us what you've built and the brands you've helped grow.
