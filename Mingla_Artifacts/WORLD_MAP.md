...
| ORCH-0425 | Flowers category polluted — garden centers/cemeteries/funeral homes/delivery-only stripped; supermarkets untouched (needs research) | Discovery | S1 | data-integrity | closed | B | 2026-04-14 | QA PASS 10/10 SC, 8/8 edge cases, 0 defects. Grade B: supermarket flowers still need per-chain research. Pending deploy + SQL cleanup + rules filter run. |
