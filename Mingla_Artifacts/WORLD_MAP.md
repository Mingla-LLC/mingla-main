...
| ORCH-0434 | **Preferences Simplification Initiative** — Restructure categories (12→8), remove budget+time slot filters, bake time into Google hours, redesign preferences sheet order+toggles, redesign onboarding to match, migrate all users | Discovery / Onboarding / Admin | S0 | architecture-flaw | in-progress | D | 2026-04-15 | **Phase 1 PASS (DB foundation).** Slugs migrated across 5 tables, RPCs rewritten, price filtering removed, backward compat confirmed. QA: `outputs/QA_ORCH-0434_PHASE1_DATABASE.md`. 8 phases remaining. |
