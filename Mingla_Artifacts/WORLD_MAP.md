...
| ORCH-0424 | Remove max selection limits on intents and categories — allow unlimited picks in onboarding and PreferencesSheet | Preferences | S2 | ux | speced | F | 2026-04-14 | INVESTIGATION + SPEC complete. 14 enforcement points, 5 product decisions locked. No DB/edge changes. Spec: SPEC_ORCH-0424_REMOVE_SELECTION_LIMITS.md. Ready for implementation dispatch. |
| ORCH-0425 | Flowers category polluted — garden centers, cemeteries, funeral homes, delivery-only; supermarkets need research before cleanup | Discovery | S1 | data-integrity | specced | F | 2026-04-14 | SPEC_ORCH-0425-0426-0427_PIPELINE_HARDENING.md. Spec approved. Implementor prompt written. Supermarket cleanup still OUT OF SCOPE (needs research). |
| ORCH-0426 | Weird places approved — gas stations, car dealer, cemetery, funeral home, zip-code lakes in pool | Discovery | S2 | data-integrity | specced | F | 2026-04-14 | SPEC_ORCH-0425-0426-0427_PIPELINE_HARDENING.md. Spec approved. Pipeline split + Stage 2 hardening + blocked types. Implementor prompt written. |
| ORCH-0427 | Fine dining undercount — 306 expensive restaurants misclassified as casual_eats only | Discovery | S1 | data-integrity | specced | F | 2026-04-14 | SPEC_ORCH-0425-0426-0427_PIPELINE_HARDENING.md. Spec approved. VERY_EXPENSIVE promotion rule + GPT prompt update. Mutual exclusivity PENDING user decision. Implementor prompt written. |
