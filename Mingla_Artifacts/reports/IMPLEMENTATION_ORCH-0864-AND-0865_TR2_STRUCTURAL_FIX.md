...
### ORCH-0864 — SafeArea structural fix
...
- **ORCH-ID collision** — orchestrator's dispatch used ORCH-0862 + ORCH-0863, both already taken. This report uses ORCH-0864 + ORCH-0865. Renumber investigation report filenames at CLOSE artifact sync OR document the collision in WORLD_MAP.
