...
- [`Mingla_Artifacts/reports/IMPLEMENTATION_ORCH-0889_MARKETING_TAB_DESKTOP_WEB_FIT_AND_FINISH.md`](IMPLEMENTATION_ORCH-0889_MARKETING_TAB_DESKTOP_WEB_FIT_AND_FINISH.md) — Wave-1 baseline this SPEC supersedes; `useStickyFooterOffset` hook + I-DISABLED-QUERY-IS-LOADING invariant + I-STICKY-FOOTER-VIA-HOOK invariant + the single-file `richEditor.tsx` web stub that ORCH-0891 replaces.
