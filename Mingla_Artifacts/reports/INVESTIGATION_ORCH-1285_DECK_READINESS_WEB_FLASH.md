# INVESTIGATION — ORCH-1285 · Venue deck-readiness "Recommend me" step flashes and closes on web after Submit (new venue stuck at `business_authoring_status='processing'`)
...
- **Severity:** DISCOVERY — not part of ORCH-1285's flash; register separately. Cleanup below preserves the place but flags an optional status/inputs revert.
