...
Not required given B1 verdict. To confirm prod state, the operator may run the verification queries already embedded in [`supabase/migrations/20260426000001_orch_0646_ai_approved_cleanup.sql:392-410`](../migrations_archive_orch_0729_2026-05-05/20260426000001_orch_0646_ai_approved_cleanup.sql) via Management API per `reference_supabase_management_api.md`:
...
|------|-----------|--------|
| [`supabase/migrations/20260409200001_optimize_city_picker_rpc.sql:11,16`](../migrations_archive_orch_0729_2026-05-05/20260409200001_optimize_city_picker_rpc.sql) | 2× `CREATE INDEX CONCURRENTLY` | **ACTIVE BOMB** |
| [`supabase/migrations/20260421000002_orch_0558_schema_hardening.sql:10`](../migrations_archive_orch_0729_2026-05-05/20260421000002_orch_0558_schema_hardening.sql) | Comment only — discusses CONCURRENTLY-split as workaround | Not a bomb (no CONCURRENTLY statement) |
...
- 5a/5b: `feedback_ai_categories_decommissioned.md` (historical source not versioned: `../../C:/Users/user/.claude/projects/c--Users-user-Desktop-mingla-main/memory/feedback_ai_categories_decommissioned.md`) referenced from MEMORY.md ✓
