...
> The clickable prototype is the centerpiece deliverable. This part defines the minimum required interactive paths. The founder will tap through these paths during week-5 review without assistance. Anything that does not respond to a tap in the sequences below is a failure.
...
> Founder signs off when every box below is checked. Until that moment, the deliverable is incomplete. Self-audit before requesting review.
