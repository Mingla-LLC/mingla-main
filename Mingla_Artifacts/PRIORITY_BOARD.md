...
| 0 | **ORCH-0641** | **🔴 filterByDateTime schema mismatch — 70% of deck silently excluded for every user** | **100** | **Singles Serving** | **S0 production incident** | **SPEC + IMPLEMENT (1-2 lines)** | **Affects every user right now. 7 of 10 chips produce zero cards. nature/creative_arts/theatre partially surface via whitelist. Fix is surgical. Must ship before any other work.** |
