...
### I-PROPOSED-1146-AI-EXPERIENCE-STAYS-DRAFT (ACTIVE — flipped at ORCH-1146 CLOSE 2026-06-15)
**Rule:** No AI/snap path writes `event_dates`, `experience_stops`, `cover_media_*`, or `published_at` for an experience; those remain unset until the brand finishes the draft in the wizard. (Restates I-2/I-4 for the parser surface — a snapped experience is always an unpublished, undated DRAFT.)
**Enforcement:** Deno test assertions in `orch_1146_create_experience_field_completeness.test.ts` (dates/cover/published_at left null on a snapped tool_args confirm); source-traced no-date/no-publish in the executor.
