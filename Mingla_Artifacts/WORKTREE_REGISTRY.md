...
| `~/Desktop/mingla-orchs/ORCH-0987-[friend-more-menu]` | `ORCH-0987-friend-more-menu` | ORCH-0987 | INVESTIGATE | iPhone 17 Pro (iOS) + Android emu — consumer friend surfaces | 8093 | 2026-05-28 | Claude `mingla-orchestrator` (spawn) → Claude `mingla-forensics` (active) |
