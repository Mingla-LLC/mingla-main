...
| `~/Desktop/mingla-orchs/0965-[home-dash-intelligent-kpis-upcoming]` | `0965-home-dash-intelligent-kpis-upcoming` | ORCH-0965 | INVESTIGATE | iPhone 17 Pro Max (business) + Android emu + buyer-web Chromium | 8087 | 2026-05-25 | Claude `mingla-orchestrator` (dispatch) → Claude `mingla-forensics` (next) |
