...
| `~/Desktop/mingla-orchs/meta-orch-0972-[brand-kind-decommission-universal-features]` | `meta-orch-0972-brand-kind-decommission-universal-features` | META-ORCH-0972 | AUDIT (Phase 1 of 4) | TBD — multi-app + backend | 8083 | 2026-05-25 | Claude `mingla-orchestrator` (dispatch) → Claude `mingla-forensics` (Phase 1 INVESTIGATE pending) |
