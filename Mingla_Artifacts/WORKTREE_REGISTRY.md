...
| `~/Desktop/mingla-orchs/ORCH-1014-[intel-trial-consolidation-photo-prune-readiness-badges]` | `ORCH-1014-intel-trial-consolidation-photo-prune-readiness-badges` | ORCH-1014 | SPEC | no sim — admin-web (Vite) | 8088 | 2026-05-30 | Claude `mingla-orchestrator` (dispatch) → Claude `mingla-forensics` (active) |
