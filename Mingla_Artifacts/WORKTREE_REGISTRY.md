...
| `~/Desktop/mingla-orchs/ORCH-0964-[public-page-theme-customization]` | `ORCH-0964-public-page-theme-customization` | ORCH-0964 | IMPLEMENT (pending dispatch — SPEC + 2 amendments APPROVED) | iPhone 17 Pro (business) + iPhone 16 (consumer) + Pixel 8 Pro + buyer-web Chromium + operator physical iPhone (Universal Link real-device verification) | 8086 | 2026-05-25 | Claude `mingla-orchestrator` (dispatch) → Claude `mingla-implementor` OR Codex `implementor-mingla` (operator chooses) |
