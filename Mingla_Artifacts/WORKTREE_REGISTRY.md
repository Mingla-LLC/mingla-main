...
| `~/Desktop/mingla-orchs/ORCH-0974-[home-mobile-section-lock-and-spacing]` | `ORCH-0974-home-mobile-section-lock-and-spacing` | ORCH-0974 | INVESTIGATE+SPEC | iPhone 17 Pro sim + Pixel emu | 8092 | 2026-05-25 | Claude `mingla-orchestrator` (dispatch) → Claude `mingla-forensics` (pending) |
