...
| `~/Desktop/mingla-orchs/META-ORCH-1009-Sub-B-[consumer-ranker-blend-3-surfaces]` | `META-ORCH-1009-Sub-B-consumer-ranker-blend-3-surfaces` | META-ORCH-1009 Sub-B | SPEC | backend + consumer-app (iOS sim assigned at IMPLEMENT) | TBD | 2026-05-30 | Claude `mingla-orchestrator` (dispatch) → Claude `mingla-forensics` (active) |
