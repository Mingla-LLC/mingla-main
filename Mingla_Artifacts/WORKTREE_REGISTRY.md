...
| `~/Desktop/mingla-orchs/ORCH-0985-[paired-profile-holidays-redesign]` | `ORCH-0985-paired-profile-holidays-redesign` | ORCH-0985 | INVESTIGATE | iPhone 17 Pro (iOS) + Android emu — consumer paired-profile view | 8092 | 2026-05-28 | Claude `mingla-orchestrator` (dispatch) → Claude `mingla-forensics` (next) |
