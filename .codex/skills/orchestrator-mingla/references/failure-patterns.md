> Parity note: ported from `.claude/skills/mingla-orchestrator/references/failure-patterns.md` during META-ORCH-0755-B so Codex orchestrator can load Claude’s recurring production-failure patterns during intake, triage, and review.
