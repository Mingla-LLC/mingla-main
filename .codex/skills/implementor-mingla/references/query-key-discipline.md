> Parity note: ported from `.claude/skills/mingla-implementor/references/query-key-discipline.md` during META-ORCH-0755-B so Codex implementor can load Claude’s granular React Query key rules when needed.
