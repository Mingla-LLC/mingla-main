> Parity note: ported from `.claude/skills/mingla-implementor/references/invariant-checklist.md` during META-ORCH-0755-B so Codex implementor can load the same pre/post-flight invariant checklist as Claude.
