> Parity note: ported from `.claude/skills/mingla-forensics/references/invariant-violations.md` during META-ORCH-0755-B so Codex forensic investigations can check the same invariant-violation taxonomy as Claude.
