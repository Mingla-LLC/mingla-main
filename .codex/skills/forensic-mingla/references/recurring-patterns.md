> Parity note: ported from `.claude/skills/mingla-forensics/references/recurring-patterns.md` during META-ORCH-0755-B so Codex forensic investigations can recognize the same recurring Mingla failure patterns as Claude.
