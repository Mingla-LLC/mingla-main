...
export default function QASettings({ userData, onSignOut }: any) {
  ...
  const handleSaveNotifications = () => {
    localStorage.setItem('qaNotificationSettings', JSON.stringify(notifications));
      ...
      <div className="space-y-6">
        ...
        <Card className="p-6 border border-gray-200">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-[#111827]">Flagged Content</p>
                <p className="text-[#6B7280] text-sm">Get notified when content is flagged</p>
              </div>
              <Switch
