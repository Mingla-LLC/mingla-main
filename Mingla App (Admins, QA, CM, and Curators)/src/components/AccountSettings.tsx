      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="font-semibold text-gray-900">Currency Preference</h3>
          </div>
          ...
          <div className="space-y-2">
            <div className="grid grid-cols-1 gap-3 max-h-60 overflow-y-auto border border-gray-100 rounded-lg p-2">
          ...
          {selectedCurrency !== 'USD' && (
            <div className="mt-4 p-3 bg-orange-50 border border-orange-200 rounded-lg">
              <p className="text-sm text-[#eb7825]">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="font-semibold text-gray-900">Measurement System</h3>
          </div>
          ...
          <div className="space-y-3">
            ...
            >
              <div className="text-left">
                ...
                <div className="text-sm text-gray-500">Miles, feet, inches, Fahrenheit</div>
              </div>
              {selectedMeasurement === 'Imperial' && (
            ...
            >
              <div className="text-left">
                ...
                <div className="text-sm text-gray-500">Kilometers, meters, centimeters, Celsius</div>
              </div>
              {selectedMeasurement === 'Metric' && (
                <Check className="w-5 h-5 text-[#eb7825]" />
              )}
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between py-2">
              ...
              <span className="text-sm font-medium text-gray-900">{supportedCurrencies.length}</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6">
          ...
          <AlertDialog>
            <AlertDialogTrigger asChild>
              <button className="w-full flex items-center justify-center gap-2 p-4 bg-red-50 border border-red-200 rounded-lg text-red-700 hover:bg-red-100 transition-colors">
              ...
              <AlertDialogHeader>
                ...
                <AlertDialogDescription className="text-left">
                  ...
                  <div className="mt-3 p-3 bg-red-50 rounded-lg">
                    <p className="text-sm text-red-700 font-medium mb-2">This will permanently remove:</p>
