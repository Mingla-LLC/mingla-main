...
const check = (s) => {
  ...
  if (!s.worker.includes('CHECKOUT_REVOCATION_EXECUTE") !== "true"')) fail("worker is not default dark");
...
if (process.argv.includes("--self-test")) {
  ...
  const mutations = [
    ...
    ["worker", 'CHECKOUT_REVOCATION_EXECUTE") !== "true"', 'CHECKOUT_REVOCATION_EXECUTE") === "false"'],
  ];
