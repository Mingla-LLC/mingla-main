...
export function audit(base = repoRoot) {
  ...
  if (!send.includes('body.action === "preview_people_v2"') || !send.includes('body.action === "confirm_people_v2"') || !send.includes("audienceVersion")) failures.push("edge Manual preview/confirm v2 contract missing");
