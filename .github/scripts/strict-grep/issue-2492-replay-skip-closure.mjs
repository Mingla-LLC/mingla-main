...
function selfTest() {
  ...
  // private-event lane TWELVE -> THIRTEEN and the #2117 lane EIGHT -> NINE.
  ...
  // GOOD 12/8 -> 13/9, M-5 12 -> 13, M-6 14 -> 15, M-9 12 -> 13, M-10 13 -> 14;
  ...
  console.log("#2492 self-test PASS (1 good tree with the 13/1/3/9 lane inventory, 10 mutants M-1…M-10 all behaving).");
}
