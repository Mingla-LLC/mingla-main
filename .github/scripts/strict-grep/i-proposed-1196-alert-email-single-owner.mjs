#!/usr/bin/env node
/**
 * I-PROPOSED-1196-ALERT-EMAIL-SINGLE-OWNER (DRAFT) — ORCH-1196.
 *
...
if (!existsSync(fnDir)) {
  console.error("I-PROPOSED-1196-ALERT-EMAIL-SINGLE-OWNER: api-health-probe dir missing");
  process.exit(1);
}
...
if (failures.length > 0) {
  console.error("I-PROPOSED-1196-ALERT-EMAIL-SINGLE-OWNER gate failed:");
  for (const f of failures) console.error(`- ${f}`);
  process.exit(1);
}
console.log("I-PROPOSED-1196-ALERT-EMAIL-SINGLE-OWNER gate passed.");
