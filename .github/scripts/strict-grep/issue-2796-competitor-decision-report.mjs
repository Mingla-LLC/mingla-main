...
for (const [source, values] of [
  ...
  [worker, ["competitor-brief-v3.5", "MAX_SYNTHESIS_REQUEST_BYTES = 65_536", "MAX_SYNTHESIS_OUTPUT_TOKENS = 2_200", "RESERVED_MICROUSD = 50_000", "groundedThemeSignals", "groundedDecisionComparisons", "groundedDecisionBindings", "primaryActionFirst", "action_id === action.id", "action.is_primary === true", "validateDecisionReport"]],
