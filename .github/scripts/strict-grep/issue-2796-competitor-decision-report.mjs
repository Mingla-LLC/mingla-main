...
for (const [source, values] of [
  ...
  [worker, ["competitor-brief-v3.4", "MAX_SYNTHESIS_REQUEST_BYTES = 65_536", "MAX_SYNTHESIS_OUTPUT_TOKENS = 3_500", "RESERVED_MICROUSD = 50_000", "groundedThemeSignals", "groundedDecisionComparisons", "groundedDecisionBindings", "primaryActionFirst", "action_id === action.id", "action.is_primary === true", "validateDecisionReport"]],
