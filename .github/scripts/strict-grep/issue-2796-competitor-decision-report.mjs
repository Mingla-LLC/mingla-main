...
for (const [source, values] of [
  ...
  [worker, ["competitor-brief-v3.1", "MAX_SYNTHESIS_REQUEST_BYTES = 65_536", "MAX_SYNTHESIS_OUTPUT_TOKENS = 1_200", "RESERVED_MICROUSD = 50_000", "groundedDecisionBindings", "validateDecisionReport"]],
